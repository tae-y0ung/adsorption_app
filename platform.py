...
# ---------------------------------------------------------
# 4-1. Chemical vs Physical
# ---------------------------------------------------------
chemical_weight = st.slider(
    "화학적 성능 비중",
    0.0,
    1.0,
    st.session_state.chemical_weight,
    0.05,
    key="chemical_weight"
)
...
# ---------------------------------------------------------
# 4-2. Chemical Internal Ratio
# ---------------------------------------------------------
st.subheader("화학적 성능 내부 비율")

petroleum_ratio = st.slider(
    "Petroleum 비율",
    0.0,
    1.0,
    st.session_state.petroleum_ratio,
    0.05,
    key="petroleum_ratio"
)
